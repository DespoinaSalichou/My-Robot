<template>
  <div>
    ...
    <div class="top-row">
      <div class="top part">
        <!-- Me to v-once to deixnei mia fora mono -->
        <div class="robot-name">
          {{ selectedRobot.head.title }}
          <span v-show="selectedRobot.head.onSale" class="sale">Sale!</span>
          <!-- To v-show to deixnei mono sto head -->
        </div>
    ...
    <table class="">
      ...
      <tbody>
        <tr v-for="(robot, index) in cart" :key="index">
          ...
          <td class="cost">{{ robot.cost  }} &euro;  </td>
...
export default {
  ...
  computed: {
    //replace stin html me to selectedRobot.head klp klp
    selectedRobot() {
      return {
  ...
  methods: {
    ...
    selectPreviousHead() {
      console.log("selectPrevioustHead called!");
      this.selectedHeadIndex = getPreviousValidIndex(
        this.selectedHeadIndex,
        availableParts.heads.length
      );
    },
    //selected methods ana part gia ola   -->
    selectNextLeftArm() {
